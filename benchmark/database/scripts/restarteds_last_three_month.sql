...
-- Since : 8.3.0
--
-- File    : restarted_last_three_months.sql
-- Purpose : this file contains the needed SQL commands to 
--           retrieve restarted jobs per week  from DB for the last 3 months
-- Usage   : mysql < restarted_last_three_months.sql
--
...
select laststartdate,count(*)
       from (
         ...
         where not isnull(laststartdate)
            ...
            and laststartdate > date_sub(now(), interval 1 quarter) group by laststartdate)
	     union all
