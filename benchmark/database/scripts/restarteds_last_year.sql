...
-- Since : 8.3.0
--
-- File    : restarted_last_year.sql
-- Purpose : this file contains the needed SQL commands to 
--           retrieve restarted jobs per month  from DB for the last year
-- Usage   : mysql < restarted_last_year.sql
--
...
select laststartdate,count(*)
       from (
         ...
         where not isnull(laststartdate)
            ...
            and laststartdate > date_sub(now(), interval 1 year) group by laststartdate)
	     union all
