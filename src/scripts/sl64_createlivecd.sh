...
CURRENTDIR=`pwd`
ROOTDIR=`dirname $0`
KSFILE=$ROOTDIR/sl64_createlivecd.ks
KSCFILENAME=$ROOTDIR/sl64_createlivecd.ks_customhostname
...
CMAKE_RPMFILENAME=cmake-2.8.8-4.el6.i686.rpm
...
CUSTOMHOSTNAME="xwlivecd_sl64.localdomain"
...
#setarch amd64 LANG=C livecd-creator --config=$KSCFILE --fslabel=XWCD-sl64_$CUSTOMHOSTNAME --tmpdir=$LIVETMPDIR
