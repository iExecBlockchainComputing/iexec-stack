 ...
 * @since 7.0.0
 */
public class SQLRequestWritable extends SQLRequestAccessible {

	/**
	 * This is the default constructor
	 */
	public SQLRequestWritable() {
		super();
		setAccesses();
	}
	...
	private void setAccesses() {
		setOtherAccess(XWAccessRights.OTHERWRITE_INT);
		setGroupAccess(XWAccessRights.GROUPWRITE_INT);
	}
