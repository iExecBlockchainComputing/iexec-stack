...
public final class XWAccessRights {
	 ...
	 * @since 8.0.0
	 */
	public final static XWAccessRights STICKYBIT = new XWAccessRights(
			STICKYBIT_INT);
	 ...
	 * @since 5.8.0
	 */
	public final static int OWNERGROUP_INT = USERALL_INT | GROUPREAD_INT
			| GROUPEXEC_INT;
	/**
	 ...
	 * @see #OWNERGROUP_INT
	 */
	public final static XWAccessRights OWNERGROUP = new XWAccessRights(
			OWNERGROUP_INT);
	/**
	 * Default access rights integer value (0x755). Owner can do everything,
	 * group can read and execute, others can read and execute
	 */
	public final static int DEFAULT_INT = USERALL_INT | GROUPREAD_INT
			| GROUPEXEC_INT | OTHERREAD_INT | OTHEREXEC_INT;
	/**
	 ...
	 */
	public final static int ALL_INT = STICKYBIT_INT | USERALL_INT
			| GROUPALL_INT | OTHERALL_INT;
	/**
	 ...
	 */
	public final static void help(PrintStream out) {
		out.printf(
				"%04X : the sticky bit that allows to bypass access rights.\n",
				STICKYBIT_INT);
		...
		out.println("");
		out.println("Regular expression to change rights : " + REGEXP
				+ " where :");
		...
		try {
			if (argv.length > 0) {
				...
				System.out.println(mod + " = "
						+ new XWAccessRights(mod).toHexString());
