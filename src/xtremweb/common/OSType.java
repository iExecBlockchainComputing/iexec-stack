...
public final class OSType extends Type {
	 ...
	 */
	public OSType(ResultSet rs) throws IOException {
		this();
		fill(rs);
	}
	 ...
	 */
	public OSType(String input) throws IOException, SAXException {
	 ...
	 */
	public OSType(File f) throws IOException, SAXException {
	 ...
	 */
	public OSType(InputStream input) throws IOException, SAXException {
		this();
	 ...
	 *             on XML error
	 */
	public OSType(Attributes attrs) {
		this();
		super.fromXml(attrs);
	}
