...
public final class SessionInterface extends xtremweb.common.Table {
	 ...
	 */
	public SessionInterface(String input) throws IOException, SAXException {
	 ...
	 */
	public SessionInterface(File f) throws IOException, SAXException {
	 ...
	 * @since 9.0.0
	 */
	public SessionInterface(SQLRequest r) {
		this();
		setRequest(r);
	}
	 ...
	 *             on XML error
	 */
	public SessionInterface(InputStream input) throws IOException, SAXException {
		this();
	 ...
	 *             on XML error
	 */
	public SessionInterface(Attributes attrs) {
		this();
		super.fromXml(attrs);
	}
	 ...
	 */
	@Override
	public void updateInterface(Table sitf) throws IOException {
	...
	public static void main(String[] argv) {
		try {
			...
			logger.exception(
					"Usage : java -cp "
							+ XWTools.JARFILENAME
							+ " xtremweb.common.SessionInterface [anXMLDescriptionFile]",
					e);
		}
	}
}
