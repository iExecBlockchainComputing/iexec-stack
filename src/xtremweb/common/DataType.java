...
public final class DataType extends Type {
	 ...
	 */
	public DataType(ResultSet rs) throws IOException {
		this();
		fill(rs);
	}
	 ...
	 */
	public DataType(String input) throws IOException, SAXException {
	 ...
	 */
	public DataType(File f) throws IOException, SAXException {
	 ...
	 */
	public DataType(InputStream input) throws IOException, SAXException {
		this();
	 ...
	 *             on XML error
	 */
	public DataType(Attributes attrs) {
		this();
		super.fromXml(attrs);
	}
	...
	public void fill(ResultSet rs) throws IOException {
		...
		try {
			...
			setDescription((String) Columns.DATATYPEDESCRIPTION
					.fromResultSet(rs));
