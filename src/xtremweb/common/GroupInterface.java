...
public final class GroupInterface extends xtremweb.common.Table {
	...
	public enum Columns implements XWBaseColumn {
		...
		/**
		 * This is the column index of the UID of the associated session, if any<br />
		 */
		SESSIONUID {
			@Override
			public UID fromString(String v) throws URISyntaxException {
				return new UID(v);
			}
		};
	 ...
	 * @since 9.0.0
	 */
	public GroupInterface(SQLRequest r) {
		this();
		setRequest(r);
	}
	 ...
	 */
	public GroupInterface(ResultSet rs) throws IOException {
		this();
		fill(rs);
	}
	 ...
	 */
	public GroupInterface(String input) throws IOException, SAXException {
	 ...
	 */
	public GroupInterface(File f) throws IOException, SAXException {
	 ...
	 *             on XML error
	 */
	public GroupInterface(InputStream input) throws IOException, SAXException {
		this();
	 ...
	 *             on XML error
	 */
	public GroupInterface(Attributes attrs) {
		this();
		super.fromXml(attrs);
	}
	...
	public static void main(String[] argv) {
		try {
			...
			logger.exception("Usage : java -cp " + XWTools.JARFILENAME
					+ " xtremweb.common.GroupInterface [anXMLDescriptionFile]",
					e);
		}
	}
}
