...
public interface CommHandler extends Handler {
	 ...
	 */
	void resetSockets() throws IOException, InvalidKeyException,
	 ...
	 *            is the socket
	 */
	void setSocket(Socket s) throws IOException, InvalidKeyException,
			AccessControlException;
	 ...
	 *            is the socket
	 */
	void setSocket(SSLSocket s) throws IOException, InvalidKeyException,
			AccessControlException;
	 ...
	 *            is the packet
	 */
	void setPacket(DatagramSocket s, DatagramPacket p) throws IOException,
