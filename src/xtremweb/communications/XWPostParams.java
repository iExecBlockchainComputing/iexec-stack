 ...
 * http://yourXWServer:4325/IDRPC?XMLDESC=<getusers><user login="yourlogin"
 * password="yourpassword" /></getuser> where IDRPC is one of IdRpc and XMLDESC
 * is a the string "XMLDESC"
 * 
...
public enum XWPostParams {
	...
	DATAFILE,
	/**
	 * This is the md5sum of a data to upload
	 * 
	 * @since 8.0.2
	 */
	DATAMD5SUM,
