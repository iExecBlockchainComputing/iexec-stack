...
/**
 * XMLRPCCommandGetUserGroups.java
 *
...
/**
 * This class defines the XMLRPCCommand to retreive user groups UID
 */
public class XMLRPCCommandGetUserGroups extends XMLRPCCommand {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.GETUSERGROUPS;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	protected XMLRPCCommandGetUserGroups() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandGetUserGroups(final URI uri, final UserInterface u) throws IOException {
		super(uri, IDRPC);
		setUser(u);
	}
	 ...
	 */
	public XMLRPCCommandGetUserGroups(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	...
	public XMLable exec(final CommClient comm)
		...
		return comm.getUserGroups(this);
	}
	 ...
	 * XMLRPCCommandGetUserGroups object. If the second argument is an XML file
	 * containing a description of an XMLRPCCommandGetUserGroups this creates an
	 * object from XML description and dumps it. <br />
	 * Usage : java -cp xtremweb.jar
	 * xtremweb.communications.XMLRPCCommandGetUserGroups aConfigFile
