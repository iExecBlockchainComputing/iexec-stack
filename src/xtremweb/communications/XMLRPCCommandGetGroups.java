...
/**
 * This class defines the XMLRPCCommand to retreive groups UID
 */
public class XMLRPCCommandGetGroups extends XMLRPCCommand {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.GETGROUPS;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	protected XMLRPCCommandGetGroups() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 * XMLRPCCommandGetGroups object. If the second argument is an XML file
	 * containing a description of an XMLRPCCommandGetGroups this creates an
