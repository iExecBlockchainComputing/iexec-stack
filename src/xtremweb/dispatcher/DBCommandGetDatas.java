...
public final class DBCommandGetDatas extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetDatas(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final Vector<UID> ret = (Vector<UID>) dbInterface.getDatas(command);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
