...
public final class DBCommandGetApps extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetApps(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final Vector<UID> ret = (Vector<UID>) dbInterface.getApplications(command);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
