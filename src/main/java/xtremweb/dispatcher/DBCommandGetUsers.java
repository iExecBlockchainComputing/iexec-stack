...
public final class DBCommandGetUsers extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetUsers(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final Vector<UID> ret = (Vector<UID>) dbInterface.getUsers(command);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
