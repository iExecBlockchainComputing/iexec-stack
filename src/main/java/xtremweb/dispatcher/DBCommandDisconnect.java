...
public final class DBCommandDisconnect extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandDisconnect(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		if (sessions != null) {
			...
			while (enums.hasNext()) {
				dbInterface.removeSession(theClient, enums.next());
			}
		}
