...
public final class DBCommandGetTasks extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetTasks(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final Vector<UID> ret = (Vector<UID>) dbInterface.tasksUID(client);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
