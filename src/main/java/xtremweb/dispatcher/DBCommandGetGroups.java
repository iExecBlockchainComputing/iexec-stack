...
public final class DBCommandGetGroups extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetGroups(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final Vector<UID> ret = (Vector<UID>) dbInterface.getGroups(command);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
