...
public final class DBCommandGet extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGet(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final XMLable ret = dbInterface.get(command);		
		mileStone.println("</get>");
		return ret;
	}
}
