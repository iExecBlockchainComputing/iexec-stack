...
public final class DBCommandGetSessions extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetSessions(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final Vector<UID> ret = (Vector<UID>) dbInterface.getSessions(command);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
