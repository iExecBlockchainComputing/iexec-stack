...
public final class DBCommandGetMarketOrders extends DBCommand implements CommCallback {

	private DBInterface dbInterface;

	public DBCommandGetMarketOrders(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		mileStone.println("<dbcommandgetmarketorders>");
		final Vector<UID> ret = (Vector<UID>) dbInterface.getAllMarketOrders(command);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
