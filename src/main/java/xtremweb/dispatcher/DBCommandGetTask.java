...
public final class DBCommandGetTask extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetTask(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		mileStone.println("<gettask>");
		final XMLable ret = dbInterface.getTask(command);
		mileStone.println("</gettask>");
		return ret;
	}
}
