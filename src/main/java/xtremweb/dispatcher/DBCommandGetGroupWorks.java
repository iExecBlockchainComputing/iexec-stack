...
public final class DBCommandGetGroupWorks extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetGroupWorks(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final Vector<UID> ret = (Vector<UID>) dbInterface.getGroupJobs(command);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
