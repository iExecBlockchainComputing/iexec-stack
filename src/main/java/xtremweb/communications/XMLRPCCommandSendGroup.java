 ...
 */
public class XMLRPCCommandSendGroup extends XMLRPCCommandSend  {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.SENDGROUP;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	public XMLRPCCommandSendGroup() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandSendGroup(final URI uri, final Table p) throws IOException {
		super(uri, IDRPC);
		setParameter(p);
	}
	 ...
	 *            defines the object to send
	 */
	public XMLRPCCommandSendGroup(final URI uri, final UserInterface u, final Table p) throws IOException {
	 ...
	 */
	public XMLRPCCommandSendGroup(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	...
	public static void main(final String[] argv) {
		try {
			...
			final XMLRPCCommandSend cmd = new XMLRPCCommandSendGroup(new URI(config.getCurrentDispatcher(), new UID()),
					config.getUser());
			cmd.test(argv);
