 ...
 */
public class XMLRPCCommandSendUserGroup extends XMLRPCCommandSend  {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.SENDUSERGROUP;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	public XMLRPCCommandSendUserGroup() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandSendUserGroup(final URI uri, final Table p) throws IOException {
		super(uri, IDRPC);
		setParameter(p);
	}
	 ...
	 *            defines the object to send
	 */
	public XMLRPCCommandSendUserGroup(final URI uri, final UserInterface u, final Table p) throws IOException {
	 ...
	 */
	public XMLRPCCommandSendUserGroup(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	...
	public static void main(final String[] argv) {
		try {
			...
			final XMLRPCCommandSend cmd = new XMLRPCCommandSendUserGroup(new URI(config.getCurrentDispatcher(), new UID()),
					config.getUser());
			cmd.test(argv);
