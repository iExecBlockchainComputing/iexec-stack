...
/**
 * XMLRPCCommandDownloadData.java
 *
 ...
 */
public class XMLRPCCommandDownloadData extends XMLRPCCommand {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.DOWNLOADDATA;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	protected XMLRPCCommandDownloadData() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 * XMLRPCCommandDownloadData object. If the second argument is an XML file
	 * containing a description of an XMLRPCCommandDownloadData this creates an
