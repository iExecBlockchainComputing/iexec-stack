 ...
 */
public class XMLRPCCommandPing extends XMLRPCCommand {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.PING;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	public XMLRPCCommandPing() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandPing(final URI uri) throws IOException {
		super(uri, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandPing(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	 ...
	 * XMLRPCCommandPing object. If the second argument is an XML file
	 * containing a description of an XMLRPCCommandPing this creates an object
	...
	public static void main(final String[] argv) {
		try {
			...
			final XMLRPCCommandPing cmd = new XMLRPCCommandPing(new URI(config.getCurrentDispatcher(), new UID()));
			cmd.test(argv);
