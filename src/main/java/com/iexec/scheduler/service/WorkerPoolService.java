...
public class WorkerPoolService {
    ...
    private WorkerPoolCreationWatcherService createWorkerPoolWatcherService;
    ...
    @Autowired
    public WorkerPoolService(Web3j web3j, CredentialsService credentialsService, WorkerPoolCreationWatcherService createWorkerPoolWatcherService) {
    ...
    private void loadWorkerPool() {
        ...
        this.workerPool = WorkerPool.load(
                createWorkerPoolWatcherService.getWorkerPoolAddress(), web3j, credentialsService.getCredentials(), ManagedTransaction.GAS_PRICE, Contract.GAS_LIMIT);
    }
    ...
    private void watchWorkerPoolPolicy(WorkerPool workerPool) {
        ...
        workerPool.workerPoolPolicyUpdateEventObservable(getStartBlock(), DefaultBlockParameterName.LATEST)
    ...
    private void watchPolicyChange(AuthorizedList authorizedList) {
        ...
        authorizedList.policyChangeEventObservable(getStartBlock(), DefaultBlockParameterName.LATEST)
    ...
    private void watchBlacklistChange(AuthorizedList authorizedList) {
        ...
        authorizedList.blacklistChangeEventObservable(getStartBlock(), DefaultBlockParameterName.LATEST)
    ...
    private void watchWhitelistChange(AuthorizedList authorizedList) {
        ...
        authorizedList.whitelistChangeEventObservable(getStartBlock(), DefaultBlockParameterName.LATEST)
