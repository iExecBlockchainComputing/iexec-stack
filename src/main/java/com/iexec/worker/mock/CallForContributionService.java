...
@Service
public class CallForContributionService implements CallForContribution {

    private static final Logger log = LoggerFactory.getLogger(CallForContributionService.class);
    ...
    @Autowired
    public CallForContributionService(CredentialsService credentialsService, EthConfig ethConfig,
    ...
    @Override
    public void onCallForContribution(WorkerPool.CallForContributionEventResponse callForContributionEvent) {
