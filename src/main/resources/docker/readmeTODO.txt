...
- docker run -it --env XWSERVERADDR="scheduler" --env XWSERVERNAME="xtrscheduler" -v /PATH/TO/CERTIFICATE/xwhepcert.pem:/xwhep/certificate/xwhepcert.pem --network=xtremweb  xtremweb/client:12.2.3-SNAPSHOT
