...
#
# Environment variables may be set when calling this script : 
...
#  - XWRAMSIZE : this may contain expected VM RAM size
#  - XWDISKSPACE : this may contain expected VM storage capacity
