...
#-----------------------------------------------------------------------------
GUINEAPIG_SEED="$1"                               #  Empty, or between 1 and 5

XW_APP_NAME=guineapig-pp-1.1.1
XW_APP_ARGS=(ILC LC-GENERAL"$GUINEAPIG_SEED" output.dat)

XW_INPUT_TYPE=' 1 local file'
XW_INPUTS=("${XW_INPUT_DIR}acc.dat")
