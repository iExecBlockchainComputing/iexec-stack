...
BASE_URI="http://dev17-portal.cpc.wmin.ac.uk:8080/repository/download?appid=1117&filename="
...
XW_INPUT_TYPE=' 1 file as URL containing "&"'
XW_INPUTS=("${BASE_URI}DARTAcousticG.wav")
