...
CURRENTDIR=`pwd`
ROOTDIR=`dirname $0`
KSFILE=$ROOTDIR/sl72_createlivecd.ks
KSCFILENAME=$ROOTDIR/sl72_createlivecd.ks_customhostname
...
CUSTOMHOSTNAME="xwlivecd_sl72.localdomain"
