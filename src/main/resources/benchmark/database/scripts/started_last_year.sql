...
-- Since : 8.3.0
--
-- File    : started_last_year.sql
-- Purpose : this file contains the needed SQL commands to 
--           retrieve started jobs per month  from DB for the last year
-- Usage   : mysql < started_last_year.sql
--
...
select laststartdate,count(*)
       from (
         ...
         where not isnull(laststartdate)
            and laststartdate > date_sub(now(), interval 1 year))
	     union all
