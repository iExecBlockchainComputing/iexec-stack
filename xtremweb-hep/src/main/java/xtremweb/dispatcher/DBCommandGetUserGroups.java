...
public final class DBCommandGetUserGroups extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandGetUserGroups(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		final Vector<UID> ret = (Vector<UID>) dbInterface.getUserGroups(command);
		XMLVector v = null;
		if (ret != null) {
			v = new XMLVector(ret);
		}
