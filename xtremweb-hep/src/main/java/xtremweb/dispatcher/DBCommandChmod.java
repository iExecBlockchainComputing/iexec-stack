...
public final class DBCommandChmod extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandChmod(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		mileStone.println("<chmod>");
		try {
			dbInterface.chmod(command);
