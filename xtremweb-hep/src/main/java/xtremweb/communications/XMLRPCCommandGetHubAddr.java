...
/**
 * This class aims to retrieve SmartSockets hub address from XWHEP server
 *
 ...
 */
public class XMLRPCCommandGetHubAddr extends XMLRPCCommand {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.GETHUBADDR;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	public XMLRPCCommandGetHubAddr() throws IOException {
		super(null, IDRPC);
	}
