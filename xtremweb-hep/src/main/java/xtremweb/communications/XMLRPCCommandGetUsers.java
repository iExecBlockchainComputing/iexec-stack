...
public class XMLRPCCommandGetUsers extends XMLRPCCommand {
	 ...
	 */
	public XMLRPCCommandGetUsers(final URI uri, final UserInterface u) throws IOException {
		super(uri, IDRPC);
		setUser(u);
	}
	 ...
	 */
	public XMLRPCCommandGetUsers(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
