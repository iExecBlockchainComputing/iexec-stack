...
public class XMLRPCCommandSendApp extends XMLRPCCommandSend  {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.SENDAPP;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	public XMLRPCCommandSendApp() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandSendApp(final URI uri, final Table p) throws IOException {
		super(uri, IDRPC);
		setParameter(p);
	}
	 ...
	 *            defines the object to send
	 */
	public XMLRPCCommandSendApp(final URI uri, final UserInterface u, final Table p) throws IOException {
	 ...
	 */
	public XMLRPCCommandSendApp(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	...
	public static void main(final String[] argv) {
		try {
			...
			final XMLRPCCommandSend cmd = new XMLRPCCommandSendApp(new URI(config.getCurrentDispatcher(), new UID()),
					config.getUser());
			cmd.test(argv);
