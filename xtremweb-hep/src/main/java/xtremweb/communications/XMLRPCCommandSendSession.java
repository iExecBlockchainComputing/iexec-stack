 ...
 */
public class XMLRPCCommandSendSession extends XMLRPCCommandSend  {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.SENDSESSION;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	public XMLRPCCommandSendSession() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandSendSession(final URI uri, final Table p) throws IOException {
		super(uri, IDRPC);
		setParameter(p);
	}
	 ...
	 *            defines the object to send
	 */
	public XMLRPCCommandSendSession(final URI uri, final UserInterface u, final Table p) throws IOException {
	 ...
	 */
	public XMLRPCCommandSendSession(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	...
	public static void main(final String[] argv) {
		try {
			...
			final XMLRPCCommandSend cmd = new XMLRPCCommandSendSession(new URI(config.getCurrentDispatcher(), new UID()),
					config.getUser());
			cmd.test(argv);
