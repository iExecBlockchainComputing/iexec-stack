...
/**
 * This class defines the XMLRPCCommand to retreive tasks UID
 */
public class XMLRPCCommandGetTasks extends XMLRPCCommand {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.GETTASKS;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	public XMLRPCCommandGetTasks() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandGetTasks(final URI uri, final UserInterface u) throws IOException {
		super(uri, IDRPC);
		setUser(u);
	}
	 ...
	 */
	public XMLRPCCommandGetTasks(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	 ...
	 * XMLRPCCommandGetTasks object. If the second argument is an XML file
	 * containing a description of an XMLRPCCommandGetTasks this creates an
	 * object from XML description and dumps it. <br />
	 * Usage : java -cp xtremweb.jar
	 * xtremweb.communications.XMLRPCCommandGetTasks aConfigFile
	 * [anXMLDescriptionFile]
	 */
	public static void main(final String[] argv) {
		try {
			final XWConfigurator config = new XWConfigurator(argv[0], false);
			final XMLRPCCommandGetTasks cmd = new XMLRPCCommandGetTasks(
