...
/**
 * This class defines the XMLRPCCommand to retreive datas UID
 */
public class XMLRPCCommandGetDatas extends XMLRPCCommand {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.GETDATAS;
	/**
	 * This is the XML tag
	 */
	...
	/**
	 * This constructs a new comand
	 */
	protected XMLRPCCommandGetDatas() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandGetDatas(final URI uri, final UserInterface u) throws IOException {
		super(uri, IDRPC);
		setUser(u);
	}
	 ...
	 */
	public XMLRPCCommandGetDatas(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	 ...
	 * XMLRPCCommandGetDatas object. If the second argument is an XML file
	 * containing a description of an XMLRPCCommandGetDatas this creates an
	 * object from XML description and dumps it. <br />
	 * Usage : java -cp xtremweb.jar
	 * xtremweb.communications.XMLRPCCommandGetDatas aConfigFile
	 * [anXMLDescriptionFile]
	 */
	public static void main(final String[] argv) {
		try {
			final XWConfigurator config = new XWConfigurator(argv[0], false);
			final XMLRPCCommandGetDatas cmd = new XMLRPCCommandGetDatas(
