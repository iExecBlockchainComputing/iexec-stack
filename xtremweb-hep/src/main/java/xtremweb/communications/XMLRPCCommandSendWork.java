 ...
 */
public class XMLRPCCommandSendWork extends XMLRPCCommandSend  {

	/**
	 * This is the RPC id
	 */
	public static final IdRpc IDRPC = IdRpc.SENDWORK;
	/**
	 * This is the XML tag
	 */
	 ...
	 */
	public XMLRPCCommandSendWork() throws IOException {
		super(null, IDRPC);
	}
	 ...
	 */
	public XMLRPCCommandSendWork(final URI uri, final Table p) throws IOException {
		super(uri, IDRPC);
		setParameter(p);
	}
	 ...
	 *            defines the object to send
	 */
	public XMLRPCCommandSendWork(final URI uri, final UserInterface u, final Table p) throws IOException {
	 ...
	 */
	public XMLRPCCommandSendWork(final InputStream input) throws IOException, SAXException, InvalidKeyException {
		this();
	...
	public static void main(final String[] argv) {
		try {
			...
			final XMLRPCCommandSend cmd = new XMLRPCCommandSendWork(new URI(config.getCurrentDispatcher(), new UID()),
					config.getUser());
			cmd.test(argv);
