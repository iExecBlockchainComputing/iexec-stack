 ...
 * @since 10.5.0
 */
public class SQLRequestWorksMatchingHosts extends SQLRequest {
	 ...
	 * @see ColumnSelection
	 */
	public SQLRequestWorksMatchingHosts() throws IOException {
		super();
	 ...
	 */
	public SQLRequestWorksMatchingHosts(final HostInterface h, final UserInterface u) throws IOException {
		this();
		host = h;
		setUser(u);
	 ...
	 */
	public SQLRequestWorksMatchingHosts(final HostInterface h, final UserInterface u, final StatusEnum s)
			throws IOException {
		this(h, u);
		status = s;
	}
