...
-- Since : 5.8.0
--
-- File    : completeds_last_week.sql
-- Purpose : this file contains the needed SQL commands to 
--           retreive completed jobs per day from DB for the last 7 days
-- Usage   : mysql < completeds_last_week.sql
--
...
select completeddate,count(*)
       from (
         ...
         where not isnull(completeddate)
            and completeddate > date_sub(now(), interval 1 week) 
