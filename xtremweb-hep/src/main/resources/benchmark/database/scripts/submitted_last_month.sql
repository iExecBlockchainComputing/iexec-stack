...
-- Since : 5.8.0
--
-- File    : submitted_last_month.sql
-- Purpose : this file contains the needed SQL commands to 
--           retrieve submitted jobs per day from DB for the last month
-- Usage   : mysql < submitted_last_month.sql
--
...
select arrivaldate,count(*)
       from (
         ...
         where not isnull(arrivaldate)
            and arrivaldate > date_sub(now(), interval 1 month))
	     union all
