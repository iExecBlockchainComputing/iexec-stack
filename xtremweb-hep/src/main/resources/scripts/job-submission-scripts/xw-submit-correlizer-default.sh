...
#-----------------------------------------------------------------------------
CORRELIZER_INPUT=${1:-linear-245077370}

XW_APP_NAME=correlizer-100.sh
XW_APP_ARGS=(-b 32  -e 32  -t linear  -f "$CORRELIZER_INPUT.bp.zLib"  -p 21)

XW_INPUT_TYPE=' the default input file of the XtremWeb-HEP application'
XW_INPUTS=()
