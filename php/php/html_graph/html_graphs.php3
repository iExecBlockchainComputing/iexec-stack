...
#######################################################################
#
#       $Id: html_graphs.php3,v 1.2 2003/09/30 07:21:54 oleg Exp $
#
#   $Author: oleg $
#   $Locker:  $
#
#     $Date: 2003/09/30 07:21:54 $
#
#   $Source: /users/archi/fedak/cvs/XtremWeb/php/php/html_graph/html_graphs.php3,v $
# $Revision: 1.2 $
#    $State: Exp $
#
#      $Log: html_graphs.php3,v $
#      Revision 1.2  2003/09/30 07:21:54  oleg
#      improved
#
#      Revision 1.1  2003/09/23 07:42:59  oleg
#      Html graphs added as library
#
#      Revision 1.1  2001/03/29 18:17:02  fedak
#      Initial www Commit
#
...
function vertical_graph($names, $values, $bars, $vals) 
   {
    ...
    $width_cell = floor(100 /SizeOf($values)) ;
...
?>
         ...
         <IMG SRC="<? echo $bars[$i] ?>" WIDTH=7 HEIGHT="<? 
        ...
        if ($values[$i] != 0)
           {
            echo floor($values[$i] * $vals["scale"]);
           } 
        else 
           { 
            echo "1";
