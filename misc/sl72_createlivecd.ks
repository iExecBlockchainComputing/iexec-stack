...
#  Arch    : 64bits
# 
#  Purpose : this is the kickstart file to create a new SL 7.2 livecd
#
#  See     : sl72_createlivecd.sh; xwcontext_prologue; xwcontext_epilogue
#
...
#  !!!!!!!!!!!!!!!!!!!!!!    DO NOT EDIT    !!!!!!!!!!!!!!!!!!!!!!!
#  !!  
#  !! This file is automatically customized by sl72_createlivecd.sh 
#  !!  
#  !!!!!!!!!!!!!!!!!!!!!!    DO NOT EDIT    !!!!!!!!!!!!!!!!!!!!!!!
#  
#  ******************************************************************
...
#%include /usr/share/livecd-tools/sl72-live-base.ks
install
cdrom
lang en_US.UTF-8
keyboard us
...
# SL repositories
repo --name=base          --baseurl=http://ftp.scientificlinux.org/linux/scientific/7.2/$basearch/os/
repo --name=security      --baseurl=http://ftp.scientificlinux.org/linux/scientific/7.2/$basearch/updates/security/
#repo --name=epel-release  --baseurl=http://download.fedoraproject.org/pub/epel/7/$basearch


# or use a mirror close to you
#repo --name=base      --baseurl=http://mirror.switch.ch/ftp/mirror/scientificlinux/7.2/$basearch/os/
#repo --name=security  --baseurl=http://mirror.switch.ch/ftp/mirror/scientificlinux/7.2/$basearch/updates/security/
#repo --name=epel      --baseurl=https://mirrors.fedoraproject.org/metalink?repo=epel-7&arch=$basearch

# fastbugs is disabled
#repo --name=fastbugs  --baseurl=http://ftp.scientificlinux.org/linux/scientific/7.2/$basearch/updates/fastbugs/
...
###############################################################################
%post --nochroot --log=/var/log/sl72_createlivecd.log
...
###############################################################################
%post --log=/var/log/sl72_createlivecd.log
