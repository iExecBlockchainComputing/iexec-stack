...
#
#  See     : sl62_createlivecd.sh; xwcontext_prologue; xwcontext_epilogue
#
...
#  !!!!!!!!!!!!!!!!!!!!!!    DO NOT EDIT    !!!!!!!!!!!!!!!!!!!!!!!
#  !!  
#  !! This file is automatically customized by sl62_createlivecd.sh 
#  !!  
#  !!!!!!!!!!!!!!!!!!!!!!    DO NOT EDIT    !!!!!!!!!!!!!!!!!!!!!!!
#  
#  ******************************************************************
...
xconfig
services --enabled=NetworkManager,network,sshd --disabled=sendmail,cups,firstboot,ip6tables
...
if [ -f /root/iptables_rules.sh ] ; then
  echo "INFO : no iptables rules : LAN access not allowed"
